...
<div class="container justify-content-center">
    ...
    <form action="#" method="post">
        <div class="row mx-lg-4 mb-3 px-5">
            <input type="email" class="form-control" placeholder="email" name="connexion-email" id="connexion-email" value="<?= $email ?>" required>
            <span class="form-errors"><?= $email_err?></span>
        </div>
        <div class="row mx-lg-4 mb-3 px-5">
            <input type="password" class="form-control" placeholder="Mot de passe" name="connexion-password" id="connexion-password" value="<?= $password ?>" required>
