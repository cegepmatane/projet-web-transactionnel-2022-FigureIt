...
<div class="container">
    <h1 class="text-left">A propos de nous</h1>
    <div class="description">
        <p>
            Nous sommes un groupe de 3 développeurs cherchant à partager notre passion pour les figurines d'occasion. 
            Il y a donc Lucas Heidet, Axel Klein et Benjamin Rodot à la tête de ce projet.
    </div>

    <h1 class="text-left">Nos objectifs</h1>
    <div class="description">
        <p>
            Pour notre part, nous cherchons à élargir le public d'achat des figurines d'occasion. Car dû aux nombreux collectionneurs,
    ...
    <h1 class="text-left">Notre systeme économique</h1>
    <div class="description">
        <p>
            Notre système économique est basé sur 2 points. Le premier sera la publicité, qui permettra de faire connaitre le site,
